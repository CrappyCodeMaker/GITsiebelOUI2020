              ...
              function ForceFocusOnControl() {
                  ...
                  if (this.GetGrid() && pm.Get("ForceFocusOnControl") && pm.Get("CloseCtrlPopupInProgress")) {
                      ...
                      if (control && control.GetFieldName() &&
                          pm.ExecuteMethod("GetListCol", ctrlName)) {
              ...
              function PrepareColumnInfoForListColumn(ColumnItem) {
                  ...
                  if (ColumnItem.control.GetShowBase() &&
                      ...
                      current.formatter = function (cellvalue, options, rowObject) {
                          ...
                          return textFormatter.call(that, cellvalue, canNavigate, options, rowObject, null, null, utils.IsTrue(control.IsEncode()));
                      };
                  }
                  ...
                  if (ColumnItem.name === this.GetPM().Get("MultiSelectColumn")) {
                      colname = ("<input role=\"checkbox\" type=\"checkbox\" id = \"" + ("id_" + this.GetPM().Get("GetPlaceholder") + this.GetPM().Get("MultiSelectColumn")) + "\" name = \"" + ("header_" + this.GetPM().Get("GetPlaceholder") + this.GetPM().Get("MultiSelectColumn")) + "\" />");
                  }
                      ...
                      if (control) {
                          ...
                          if (el && el.length > 0) {
                              switch (control.GetUIType()) {
                                  case combo:
                                      pm.SetProperty("CloseCtrlPopupInProgress", true);
                                      el.autocomplete("close");
                                      pm.SetProperty("CloseCtrlPopupInProgress", false);
                                      break;
              ...
              *  */
              ...
              JQGridRenderer.prototype.PostBindData = function () {
                  ...
                  DOMUtils.Read(function () {
                      var gridHeight = Number(jqGridCtrl.height()),
                          height = gridHeight + Number(GridPadding) - 2; //oliver: added -3 to better fit window
                      ...
                      DOMUtils.Write(function () {
                          ...
                          if (gridHeight === 0 && showElastic && !disableElasticGrid) {
                                jqGridCtrl.setGridHeight(estHeight + Number(GridPadding) - 2);
                          }
                          if (SiebelAppFacade.DecisionManager.IsTouch()) {
              ...
              JQGridRenderer.prototype.ShowSelection = function (index) {
                  ...
                  if (pm.Get("IsInQueryMode")) {
                      ...
                      if (!isMultiRowForm) {
                          SiebelAppFacade.JQGridRenderer.superclass.ShowSelection.call(this, (index && jqGridCtrl.length > 0) || undefined, GetBaseAppletControls.call(this));
                      }
                  }
              };
